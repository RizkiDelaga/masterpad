            ...
            >
              ...
              <Box sx={{ display: 'flex', flexDirection: 'column', gap: 5 }}>
                ...
                <Box sx={{ textAlign: 'center' }}>
                  &#169;2024 <strong>Masterpad</strong> - <span style={{ fontSize: '14px' }}>Powered by</span>{' '}
            ...
            >
              ...
              <Container maxWidth="sm">
                <Button
                  ...
                  size="large"
                  onClick={() => {
                    window.location.href = 'http://localhost:3000/SSOValidation?directTo=http://localhost:3002';
                  }}
                  sx={{ width: '100%' }}
                >
                  Login Now
                ...
                <Button
                  ...
                  size="large"
                  onClick={() => {
                    window.location.href = 'http://localhost:3000/Register?directTo=http://localhost:3002';
                  }}
                  sx={{ width: '100%' }}
                >
